...
export default function AccountVerification({
  ...
  const handleSubmit = async (data: AccountVerificationSchemaType) => {
    toast.loading("Envoi de la demande de réinitialisation...", {
      id: "password-reset",
    });
    try {
      ...
      setEmail(data.email);
      toast.success(
        "Un code de réinitialisation vient d'être envoyé à votre adresse.",
        {
          id: "password-reset",
        },
      );
      ...
      toast.error(
        "Impossible d'envoyer le code. Vérifiez votre adresse et réessayez.",
        {
          id: "password-reset",
        },
      );
